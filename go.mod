module github.com/RegenNetwork/regen-ledger/v5
...
require (
	...
	github.com/RegenNetwork/regen-ledger/x/data/v2 v2.0.0
	github.com/RegenNetwork/regen-ledger/x/ecocredit/v3 v3.0.0
	github.com/RegenNetwork/regen-ledger/x/intertx v1.0.0
...
require (
	...
	github.com/RegenNetwork/regen-ledger/api/v2 v2.0.0 // indirect
...
replace github.com/RegenNetwork/regen-ledger/api/v2 => ./api

replace github.com/RegenNetwork/regen-ledger/types/v2 => ./types

replace github.com/RegenNetwork/regen-ledger/x/data/v2 => ./x/data

replace github.com/RegenNetwork/regen-ledger/x/ecocredit/v3 => ./x/ecocredit

replace github.com/RegenNetwork/regen-ledger/x/intertx => ./x/intertx
...
// https://github.com/RegenNetwork/regen-ledger/security/dependabot/86
